...
infobaseUser=""
infobasePwd=""
deniedMessage='Согласованы плановые работы. Установка релиза. Плановое время недоступности с 08:00 по 09:00 МСК 11.09.2019'
permissionCode="123"
...
then
	...
	echo "begin lock infobase and disconnect user"
    ...
    --denied-message="$deniedMessage" --denied-from="" --permission-code="$permissionCode" $rasServer
